...
import (
	...
	// EnableSwaggerDocs is set. Generated by `make swagger`; see
	// CLAUDE.md — never hand-edit internal/swaggerdocs/*.
...
func main() {
	...
	// Dev-only Swagger UI, off by default (see config.EnableSwaggerDocs) — it
	// carries no auth of its own, unlike every route above, so it must never
	// be enabled in production. Mounted under /api like everything else, at
	// /api/docs/index.html.
